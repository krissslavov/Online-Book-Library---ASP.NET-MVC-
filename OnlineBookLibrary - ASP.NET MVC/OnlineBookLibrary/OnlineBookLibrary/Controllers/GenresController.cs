...
namespace OnlineBookLibrary.Controllers
{
    ...
    public class GenresController : Controller
    {
        ...
        // GET: Genres
        public ActionResult Index(int? page,string descriptionSearch)
        {
            int pageNumber = page ?? 1;
            int pageSize = 5;
            IQueryable<Genre> genres = db.Genres.AsQueryable();

            ViewBag.DescriptionSearch = descriptionSearch;
            if (!String.IsNullOrEmpty(descriptionSearch))
            {
               genres = genres.Where(x => x.Description.Contains(descriptionSearch));
            }

            return View(genres.ToList()); //View(db.Genres.ToList());
        }
